...
func parseJobState(s []byte) (state string, err error) {
...
func FindJobState(conn *Conn, id int) (string, error) {
...
func SubmitJob(conn *Conn, path string) (id int, err error) {
